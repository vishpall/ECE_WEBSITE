...
<body>
  <header class="cd-header container flex justify-between items-center">
    ...
    <img src="img/Security.svg" style="width: 100%; height: 100%; position: absolute;
   top:15%; left:15%">
...
<div class='card2'>
  <div class='imgBox'>
    Update Records
    <img src="img/refresh.svg" style="width: 4em; height: 5em; padding-left: 30%;">
  </div>
<div class="admin-update-records">
<form action="update.php" method="post">
  ...
  <label for="rolls"><b>Enter roll no   :  </b></label>
    ...
    <label for="phno"><b>Enter Phone no :  </b></label>
      ...
      <label for="phno"><b>Enter Mail-id:  </b></label>
      <input type="email" placeholder="eg : Abc@gmail.com" name="mail_id" required><br>
...
<div class="card">
  <div class='imgBox'>
    component Renewal
    <img src="img/renew.svg" style="width: 3em; height: 4em; padding-left: 15%;">
  </div>

<div class="admin-component-renewal" >
<form action="#" method="post">
  <h2>component Renewal</h2>
  <label for="rolls"><b>Enter roll no   :  </b></label>
  <input type="text" placeholder="eg : 160218735031" name="roll_no" required><br>
  <label for="date1"><b>Enter Date of Return :  </b></label>
        <input type="date" placeholder="eg : 2020-04-01" name="date" required><br>
