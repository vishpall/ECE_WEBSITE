...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Archivo+Black&family=Roboto:wght@300;400;500;700&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="Css_Files/css_inkEffect/reset.css"> <!-- CSS reset -->
    <link rel="stylesheet" href="CSs_Files/css_inkEffect/style.css">
    <link rel="stylesheet" type="text/css" href="Css_Files/assets/css/style.css">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="Css_Files/style_AboutUs.css">
  <link rel="stylesheet" type="text/css" href="Css_Files/style-acumen-mainsite.css">
...
<header class="cd-header container flex justify-between items-center">
  ...
  <span class="text-wrapper">
    ...
    <span class="letters letters-left">About</span>
    <span class="letters ampersand">&amp;</span>
    <span class="letters letters-right">Us</span>
  ...
  <div class="center">
    <h1></h1>
    <a href="#0" class="cd-btn cd-modal-trigger">
...
<script src="Css_Files/assets/js/main.js"></script>
  ...
  <div class="card-menu-section card-menu-section-2 active" data-section="2" id="card-menu-section card-menu-section-2 active">
    <div class="card-menu-menu-btn"></div>
    <h2 class="card-menu-section-heading">Home Page</h2>


      <div style="width: 200px; height: 300px ; background-color: pink; z-index: 3;">
        this is a new div
      </div>
...
<div class="lightbox-adnonad" id="lightbox-adnonad">
  <!--<a href="#card-menu-section card-menu-section-2 active" class="card-menu-section card-menu-section-2 active"><button id="close-lightbox-button">Close</button></a>-->
      <div class="forms-lightbox-adnonad">
        <div class="signin-signup">
          <form action="validate_admin.php" class="sign-in-form" method="post">
            <h2 class="title">Admin login</h2>
            <button id="close-lightbox-button-admin" onclick="closeLightbox()"><img src="img/close.svg" width="30" height="30"></button>
      ...
      <div class="panels-lightbox-adnonad">
        <div class="panel left-panel">
          <div class="content">
            <h3>New here ?</h3>
            <p>
              Get access to the Portal of subtleness!!
            </p>
            <button class="btn transparent" id="sign-up-btn">
              Non-Admin
            </button>
          </div>
          <img src="img/technology.svg" class="image" alt="" />
        </div>
        <div class="panel right-panel">
          <div class="content">
            <h3>Be Loyal!</h3>
            <p>
              Honesty is the best Policy, We expect the same from you.
            </p>
            <button class="btn transparent" id="sign-in-btn">
              Admin
            </button>
          </div>
          <img src="img/database.svg" class="image" alt="" />
        </div>
      </div>
    </div>
...
<script>document.getElementsByTagName("html")[0].className += " js";</script>
    ...
    <script type="text/javascript" src='https://cdnjs.cloudflare.com/ajax/libs/jquery.ripples/0.5.3/jquery.ripples.js'></script>
  ...
  <script type="text/javascript" src="javascript_files/javascript_AboutUs.js"></script>
  <script src="javascript_files/js_inkeffect/jquery-2.1.4.js"></script>
  <script src="javascript_files/js_inkeffect/main.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/wavify@1.0.0/jquery.wavify.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/wavify@1.0.0/wavify.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/wavify@1.0.0/wavify.min.js"></script>
<!--<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.4.2/gsap.min.js"></script>-->
<script type="text/javascript" src="javascript_files/javascript_SupportUs.js"></script>
<script src="javascript_files/javascript_website.js"></script>
<script src="javascript_files/javascript-lightbox-adnonad.js"></script>

<script type="text/javascript" src="javascript_files/Background_ColorChange.js"></script>
</body>
</html>